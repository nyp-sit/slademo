            ...
            if (!isGPSEnabled && !isNetworkEnabled) {
                ...
                lm.requestLocationUpdates(provider, 1000, 1, new LocationListener() {
                    ...
                    public void onLocationChanged(Location location) {
                        ...
                        Location previousLocation = LocationService.this.previousLocation;
                        System.out.println("location changed");

                        //Geofence changes
                        String[] locations = getApplicationContext().getResources().getStringArray(R.array.locations_geofence);
